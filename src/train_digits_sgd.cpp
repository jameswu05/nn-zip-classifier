...
int main() {
    ...
    std::ofstream fout("errors_sgd.csv");
    for (size_t i = 0; i < errors.size(); i++) {
        fout << i << "," << errors[i] << "\n";
    }
    fout.close();

    std::cout << "Errors saved to errors_sgd.csv." << std::endl;
    ...
    std::cout << "Errors saved to errors_sgd.png." << std::endl;
    ...
    std::cout << "Decision boundary saved to decision_boundary_sgd.png." << std::endl;
